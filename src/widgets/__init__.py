...
from .pages import HomePage, LoginPage, ArtistsPage, PlaylistsPage, SongsStarredPage, SongsAllPage, AlbumsPage, AlbumsAllPage, RadiosPage, WelcomePage, SetupPage
